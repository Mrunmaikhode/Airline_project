	...
	public:
		...
		void flights()
		{
			...
			switch(choice)
			{
				case 1:
					{
						cout<<"Welcome to Dubai Emirates_\n"<<endl;
			...
			case 2:
				{
					cout<<"Welcome to Canadian Airlines_\n"<<endl;
				...
				case 5:
					{
						cout<<"Welcome to Australian Airlines_\n"<<endl;
					...
					case 6:
						{
							cout<<"Welcome to European Airlines_\n"<<endl;
...
void mainMenu()
{
	...
	switch(lchoice)
	{
		...
		case 1:
			...
			case 2:
				{
					cout<<"__Book a flight using this system ____________\n"<<endl;
					r.flights();
					break;
				}
